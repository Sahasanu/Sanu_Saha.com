...
function Project() {
    ...
    return (
        <div className='project_container text-gray-300 lg:mt-[5vh] mt-[3vh]'>
            ...
            <div className="cards w-[90%] mx-auto mt-[5vh] flex flex-wrap gap-[20px] justify-center">
                {projects.map((project, index) => (
                    <div key={index} className="card w-[90%] sm:w-[45%] md:w-[30%] p-[1vw] rounded-[10px] flex-col flex items-center bg-[#76b5f927] mb-[2vh]">
                        <div className="thumb w-[95%] h-[25vh] md:h-[30vh] rounded-[10px] overflow-hidden">
                        ...
                        <div className="dis w-[95%] mt-[2vh]">
                            ...
                            <div className="technologies flex gap-[10px] mt-[2vh] text-gray-900 flex-wrap justify-center">
                        ...
                        <div className="link w-[95%] text-center mt-[3vh]">
                            <a href={project.link} target="_blank" rel="noopener noreferrer">
                                <button className='bg-[rgb(153,106,255)] w-[80%] h-[6vh] rounded-[6px] font-bold text-[16px] md:text-[18px] hover:cursor-pointer'>
                                    Github Link
                                </button>
                            </a>
                        </div>
